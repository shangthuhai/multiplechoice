...
<head>
    ...
    <title>Sua de thi: {{ $quiz->title }}</title>
...
<body class="bg-white" data-auth-required="true">
    ...
    <main class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <form action="{{ route('quiz.update', $quiz->id) }}" method="POST" id="quizForm" class="space-y-6">
            @csrf
            @method('PUT')
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    ...
                    <div>
                        ...
                        <input type="number" name="minutes" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500"
                               value="{{ old('minutes', $quiz->minutes) }}" min="1" required>
                    </div>
                </div>
            </div>
    ...
    <script>
        const existingQuestions = @json($editableQuestions);
