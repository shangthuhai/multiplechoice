...
<div class="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-50">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div class="flex justify-between items-center mb-8">
            ...
            <a href="{{ route('questions.create') }}" class="inline-flex items-center gap-2 bg-indigo-600 hover:bg-indigo-700 text-white px-6 py-3 rounded-lg font-medium transition">
                    ...
                    <div class="bg-white rounded-lg shadow hover:shadow-lg transition border border-gray-200">
                        <div class="p-6">
                            <div class="flex justify-between items-start mb-4">
                                <div class="flex-1">
                                    <p class="text-gray-500 text-sm mb-2">Câu hỏi #{{ $question->id }}</p>
                                ...
                                <div class="flex gap-2 ml-4">
                                    <a href="{{ route('questions.show', $question->id) }}" class="inline-flex items-center gap-1 text-blue-600 hover:text-blue-700 font-medium px-3 py-2 rounded transition hover:bg-blue-50">
                                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    ...
                                    <a href="{{ route('questions.edit', $question->id) }}" class="inline-flex items-center gap-1 text-amber-600 hover:text-amber-700 font-medium px-3 py-2 rounded transition hover:bg-amber-50">
                                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z"></path>
                                        </svg>
                                        Sửa
                                    </a>
                                    <button onclick="deleteQuestion({{ $question->id }})" class="inline-flex items-center gap-1 text-red-600 hover:text-red-700 font-medium px-3 py-2 rounded transition hover:bg-red-50">
                                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    ...
                                    @foreach($question->options as $option)
                                        <div class="flex items-center gap-2 text-sm">
                                            @if($option->is_correct)
                                                ...
                                                <span class="text-green-700 font-medium">{{ $option->text }}</span>
                                            @else
