...
<div class="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-50">
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <!-- Header -->
        <div class="mb-8">
            <h1 class="text-4xl font-bold text-gray-900">Tạo câu hỏi mới</h1>
            <p class="text-gray-600 mt-2">Tạo một câu hỏi trắc nghiệm cho bài kiểm tra của bạn</p>
        </div>

        <!-- Create Form -->
        <div class="bg-white rounded-lg shadow border border-gray-200 p-8">
            <form id="createQuestionForm" class="space-y-6">
                <?php echo csrf_field(); ?>
                ...
                <div class="flex gap-4 pt-6 border-t border-gray-200">
                    ...
                    <a
                        href="<?php echo e(route('questions.index')); ?>"
        ...
        <div class="option-row" id="${optionId}">
            <div class="flex gap-3 items-start bg-gray-50 p-4 rounded-lg">
                ...
                <div class="flex-1">
                    <input
                        type="text"
                        name="options[${optionCount - 1}][text]"
...
document.getElementById('createQuestionForm').addEventListener('submit', async function(e) {
    ...
    try {
        const response = await fetch('<?php echo e(route("questions.store")); ?>', {
            method: 'POST',
            headers: {
        ...
        if (response.ok && data.success) {
            ...
            errorText.textContent = data.error || 'Lỗi khi tạo câu hỏi';
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\0pham\Documents\GitHub\multiplechoice\resources\views\questions\create.blade.php ENDPATH**/ ?>