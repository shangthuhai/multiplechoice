...
<head>
    ...
    <title><?php echo e($quiz->title ?? 'Bài thi'); ?></title>
...
<body class="bg-white" data-auth-required="true">
    ...
    <main class="min-h-[calc(100vh-80px)] flex items-center justify-center px-4">
        <form action="<?php echo e(route('quiz.submit', $quiz->id)); ?>" method="POST" class="w-full max-w-2xl">
            <?php echo csrf_field(); ?>

            <div class="card-lg p-8 text-center">
                <div class="mb-8">
                    <h2 class="text-3xl font-bold text-gray-900 mb-4"><?php echo e($quiz->title); ?></h2>
                ...
                <div class="grid grid-cols-2 gap-6 mb-8 py-6 border-y border-gray-200">
                    <div>
                        <div class="text-3xl font-bold text-blue-600 mb-2"><?php echo e($quiz->questions_count); ?></div>
                        <div class="text-sm text-gray-600">Câu hỏi</div>
                    </div>
                    <div>
                        <div class="text-3xl font-bold text-amber-600 mb-2"><?php echo e($quiz->minutes); ?></div>
                ...
                <div class="space-y-3 flex flex-col">
                    ...
                    <a href="<?php echo e(route('quiz.index')); ?>" class="px-4 py-2.5 text-gray-700 hover:text-gray-900 font-medium transition-colors">
                        ← Quay lại danh sách
                    </a>
                </div>
            </div>
...
</html><?php /**PATH C:\Users\0pham\Documents\GitHub\multiplechoice\resources\views\quiz\show.blade.php ENDPATH**/ ?>