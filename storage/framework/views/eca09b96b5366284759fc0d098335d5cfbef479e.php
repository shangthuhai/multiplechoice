...
<body>
    <nav class="navbar fixed-top navbar-dark top-bar shadow-sm">
        <div class="container">
            <span class="navbar-brand mb-0 fw-bold"><?php echo e($quiz->title); ?></span>
            <div class="d-flex align-items-center gap-2">
                <span class="pill pill-progress" id="answeredCounter">Đã chọn 0 / <?php echo e($quiz->questions->count()); ?></span>
                <span class="pill pill-time"><?php echo e($quiz->minutes); ?> phút</span>
            </div>
        </div>
    </nav>
                ...
                <div class="quiz-head p-3 p-md-4">
                    ...
                    <div class="tracker-grid">
                        <?php $__currentLoopData = $quiz->questions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $question): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="tracker-item" id="tracker-<?php echo e($question->id); ?>"><?php echo e($index + 1); ?></div>
                ...
                <div class="p-3 p-md-4">
                    ...
                    <div class="question-card mb-4 p-3 p-md-4">
                        <div class="d-flex justify-content-between align-items-start gap-3 mb-3">
                            <h5 class="question-title mb-0">Câu <?php echo e($index + 1); ?>. <span class="fw-normal"><?php echo e($question->question_text); ?></span></h5>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <label class="option-label" for="opt-<?php echo e($option->id); ?>">
                                    <span class="me-2"><?php echo e(chr(64 + $loop->iteration)); ?>.</span><?php echo e($option->option_text); ?>
