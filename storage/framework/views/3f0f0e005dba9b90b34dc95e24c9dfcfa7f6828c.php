            ...
            <form id="editQuestionForm" class="space-y-6">
                ...
                <div>
                    ...
                    <textarea
                        ...
                        minlength="5"
                        maxlength="1000"
                    ><?php echo e($question->text); ?></textarea>
                ...
                <div class="flex gap-4 pt-6 border-t border-gray-200">
                    ...
                    <a
                        href="<?php echo e(route('questions.show', $question->id)); ?>"
...
function loadExistingOptions() {
    const questions = <?php echo json_encode($question, 15, 512) ?>;
    const options = <?php echo json_encode($question->options, 15, 512) ?>;
...
document.getElementById('editQuestionForm').addEventListener('submit', async function(e) {
    ...
    try {
        const response = await fetch('<?php echo e(route("questions.update", $question->id)); ?>', {
            method: 'POST',
            headers: {
        ...
        if (response.ok && data.success) {
            alert(data.message);
            window.location.href = '<?php echo e(route("questions.show", $question->id)); ?>';
        } else {
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\0pham\Documents\GitHub\multiplechoice\resources\views\questions\edit.blade.php ENDPATH**/ ?>