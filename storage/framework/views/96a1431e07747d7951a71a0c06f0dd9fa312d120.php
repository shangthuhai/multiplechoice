...
<div class="container mt-4">
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <a href="<?php echo e(route('quiz.index')); ?>" class="btn btn-outline-secondary">Quay lại danh sách</a>
    </div>
    ...
    <form action="<?php echo e(route('quiz.store')); ?>" method="POST" id="quizForm">
        <?php echo csrf_field(); ?>
...
</html><?php /**PATH C:\Users\0pham\trac-nghiem\resources\views/quiz/create.blade.php ENDPATH**/ ?>