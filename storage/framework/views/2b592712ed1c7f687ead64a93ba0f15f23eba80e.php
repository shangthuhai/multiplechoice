...
<body class="bg-gradient-to-br from-gray-50 to-gray-100 min-h-screen flex items-center justify-center" data-auth-required="true">
    <div class="card-lg max-w-md w-full p-8">
        <div class="text-center">
            ...
            <h2 class="text-3xl font-bold text-gray-900 mb-2"><?php echo e($quiz->title); ?></h2>
            <p class="text-gray-600 mb-8">Sẵn sàng chứ? Tập trung tối đa và chọn đáp án chính xác.</p>

            <!-- Stats -->
            <div class="grid grid-cols-2 gap-4 mb-8">
                <div class="p-4 bg-blue-50 rounded-lg">
                    <div class="text-2xl font-bold text-blue-600 mb-1"><?php echo e($quiz->questions_count); ?></div>
                    <div class="text-sm text-gray-600">Câu hỏi</div>
                </div>
                <div class="p-4 bg-amber-50 rounded-lg">
                    <div class="text-2xl font-bold text-amber-600 mb-1"><?php echo e($quiz->minutes); ?></div>
            ...
            <!-- Actions -->
            <div class="space-y-3">
                <a href="<?php echo e(route('quiz.take', $quiz->id)); ?>" class="btn-primary w-full py-3 font-semibold text-center">
                    Bắt đầu làm bài →
                </a>
                <a href="<?php echo e(route('quiz.index')); ?>" class="block px-4 py-2 text-gray-700 hover:text-gray-900 font-medium transition-colors">
                    ← Quay lại danh sách
                </a>
            </div>
        </div>
